...
if __name__ == "__main__":
    ...
    parser.add_argument('--filename', type=str, default='BCH_63_51')
    parser.add_argument('--z_factor', type=int, default=24)
    parser.add_argument('--clip_llr', type=float, default=20)
    parser.add_argument('--decoding_type', type=int, default=0) #0: SP, 1: MS
    parser.add_argument('--sharing', nargs='+', type=int, default=[3,3,3]) #[cn_weight,ucn_weight,ch_weight], 1: Edges/Iters 2: Node/Iter 3: Iter
    parser.add_argument('--iters_max', type=int, default=50)
    ...
    parser.add_argument('--training_num', type=int, default=50000)
    parser.add_argument('--valid_num', type=int, default=5000)
    parser.add_argument('--epoch_input', type=int, default=100)
    parser.add_argument('--learn_rate', type=float, default=1e-3)
    parser.add_argument('--seed_in', type=int, default=2)
